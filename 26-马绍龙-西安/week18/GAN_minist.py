...
class GAN():
    def __init__(self):
        ...
        # Build and compile the discriminator判别器
        self.discriminator = self.build_discriminator()
        self.discriminator.compile(loss='binary_crossentropy',
            optimizer=optimizer,
            metrics=['accuracy'])

        # Build the generator生成器
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        # Adversarial ground truths 构建数据集
        ...
        for epoch in range(epochs):
            ...
            # Select a random batch of images通过随机输入得到一张图片
