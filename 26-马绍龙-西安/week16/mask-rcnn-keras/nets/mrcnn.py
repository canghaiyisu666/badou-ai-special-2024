...
def rpn_graph(feature_map, anchors_per_location):
    ...
    # 代表这个先验框对应的类
    rpn_class_logits = Reshape([-1,2])(x)             #softmax之前的结果， 是中间结果，也输出
...
def get_predict_model(config):
    ...
    P6 = MaxPooling2D(pool_size=(1, 1), strides=2, name="fpn_p6")(P5)      #P6是单独的，只在训练中使用

    # P2, P3, P4, P5, P6可以用于获取建议框
    rpn_feature_maps = [P2, P3, P4, P5, P6]                                   #P6是单独的，只在训练中使用
